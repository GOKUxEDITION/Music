...
class MakeButtons:
    ...
    def source_markup(self):
        buttons = [
            [
                self.ikb(text="Github ❤️", url="https://github.com/MRDADGOKU"),
                self.ikb(text="Repo 📦", url="https://t.me/GOKUxEDITION"),
            ],
            [
                self.ikb(text="Under HellBot Network { 🇮🇳 }", url="https://t.me/EditionServer"),
            ],
            [
                self.ikb(text="Support 🎙️", url="https://t.me/EditionServer"),
                self.ikb(text="Updates 📣", url="https://t.me/MagicLoader"),
            ],
            [
